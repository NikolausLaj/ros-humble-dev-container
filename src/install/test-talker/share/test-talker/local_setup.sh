...
: ${AMENT_CURRENT_PREFIX:="/ros-humble-dev-container/src/install/test-talker"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test-talker/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test-talker/environment/path.sh"
